...
class Translator():
    ...
    def translateInput(self, numberOfIterations, textInput):
        ...
        for x in range(0, numberOfIterations):
            ...
            self.notIdentified = True
            self.notAcceptedLanguageCounter = 0
            print('before while ', self.notAcceptedLanguageCounter)

            while self.notIdentified == True:

                languageDetection = self.language_translator.identify(textInput)
                currentLanguage = languageDetection[u'languages'][self.notAcceptedLanguageCounter][u'language']
                ...
                try:
                    ...
                    print(self.notAcceptedLanguageCounter)
                    self.notAcceptedLanguageCounter = self.notAcceptedLanguageCounter + 1
                    print(currentLanguage)
                    print(self.notAcceptedLanguageCounter)
