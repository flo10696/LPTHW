...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print "melting sound as the mechanism is fused togeter."
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print "the bomb. You die knwoing they will probably blow up when"
            print "it goes off."
            return 'death'
            ...
            print "and blast the lock so the Gothons cant't get out."
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print "implodes as teh hull rupture, crushing your body"
